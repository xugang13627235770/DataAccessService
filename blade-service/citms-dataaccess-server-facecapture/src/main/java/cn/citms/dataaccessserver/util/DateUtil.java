...
public class DateUtil {
    ...
    public static final String Hour_COMPACT_FORMAT = "yyyyMMddHH";
    ...
    /**
     * 获得当前时间(小时)并格式化：yyyyMMddHH
     * @return
     */
    public static String getCurrentHourCompact() {

        SimpleDateFormat sdf = new SimpleDateFormat(Hour_COMPACT_FORMAT);
        String currentDate = sdf.format(new Date());
        return currentDate;
    }
